                        ...
                        <form method="POST" action="{{route('submit_add_cabinet')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group row">
                                    <input id="first_name" type="text" class="form-control @if ($errors->has('first_name')) is-invalid  @endif" name="first_name" value="{{ old('first_name') }}" >
                            ...
                            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group row">
                                    <input id="last_name" type="text" class="form-control @if ($errors->has('last_name')) is-invalid  @endif" name="last_name" value="{{ old('last_name') }}" >
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group row">
                                    <input id="phone" type="text" class="form-control @if ($errors->has('phone')) is-invalid  @endif" name="phone" value="{{ old('phone') }}" >
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group row">
                                    <input id="date_of_birth" type="text" class="form-control @if ($errors->has('date_of_birth')) is-invalid  @endif" name="date_of_birth" value="{{ old('date_of_birth') }}" >
                            ...
                            <div class="form-group{{ $errors->has('city_of_residence') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group row">
                                    <input id="city_of_residence" type="text" class="form-control @if ($errors->has('city_of_residence')) is-invalid  @endif" name="city_of_residence" value="{{ old('city_of_residence') }}" >
                            ...
                            <div class="form-group{{ $errors->has('telegram') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group row">
                                    <input id="telegram" type="text" class="form-control @if ($errors->has('telegram')) is-invalid  @endif" name="telegram" value="{{ old('telegram') }}" >
