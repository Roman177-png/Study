        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('submit-edit-cabinet',[$cabinet->id])}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group row">
                                <label for="first_name" class="col-md-4 col-form-label text-md-right">first_name</label>

                                <div class="col-md-6">
                                    <input id="first_name" type="text" class="form-control @if ($errors->has('first_name')) is-invalid  @endif" name="first_name"value="{{$cabinet->first_name}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text" class="form-control @if ($errors->has('last_name')) is-invalid @endif" name="last_name" value="{{ $cabinet->last_name }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" class="form-control @if ($errors->has('email')) is-invalid @endif" name="email" value="{{ $cabinet->email }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control @if ($errors->has('phone')) is-invalid @endif" name="phone" value="{{ $cabinet->phone }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date_of_birth" type="text" class="form-control @if ($errors->has('date_of_birth')) is-invalid @endif" name="date_of_birth" value="{{ $cabinet->date_of_birth }}" >
                            ...
                            <div class="form-group row">
                                <label for="city_of_residence" class="col-md-4 col-form-label text-md-right">city_of_residence</label>

                                <div class="col-md-6">
                                    <input id="city_of_residence" type="text" class="form-control @if ($errors->has('city_of_residence')) is-invalid @endif" name="city_of_residence" value="{{ $cabinet->city_of_residence }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="telegram" type="text" class="form-control @if ($errors->has('telegram')) is-invalid @endif" name="telegram" value="{{ $cabinet->telegram }}" >
                            ...
                            @if($cabinet->images)
                                <img src="{{asset("storage/cabinets/$cabinet->id/$cabinet->images")}}">
                            @else
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="images" type="file" class="form-control @if ($errors->has('images')) is-invalid @endif" name="images"  >
                            ...
                            <div class="input-group">
                                <span class="col-md-4 col-form-label text-md-right">about_self</span>
                                <textarea name="about_self" class="form-control" aria-label="With textarea">{{$cabinet->about_self}}</textarea>
                            </div>
